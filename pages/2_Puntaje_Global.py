...
st.set_page_config(page_title="Puntaje Global", layout="wide")

encabezado_pagina(
    "Puntaje Global",
    "Modelo de regresión — Juan Felipe",
    pregunta="¿Qué puntaje global esperado tendría un estudiante según su "
             "perfil socioeconómico, familiar, escolar e institucional?",
)
...
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("### 3. Validación gráfica")
...
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("### 4. Importancia de variables (permutation importance)")
...
# ─────────────────────────────────────────────────────────────────────────────
st.markdown("### 5. Simulador de puntaje global")
